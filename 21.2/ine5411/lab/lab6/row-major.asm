.data
_vetor: .word 5:3000    # Cria a matriz na memória com todos os seus elementos iguais a "5"
.text
li $s6, 600			    # $s6 = número total de linhas
li $s7, 5 			    # $s7 = número total de colunas
